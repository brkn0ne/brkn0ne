...
if len(sys.argv) != 2:
    print("Usage: python3 jobprog_loop.py <jobid>")
    sys.exit(1)
...
# Function to check job status and print details
def check_job_status(jobid):
    ...
    if matches:
        ...
        print(f"\n--- Job Check at {datetime.now(timezone.utc)} ---")
...
# Run the check every 5 minutes in a loop
try:
    while True:
